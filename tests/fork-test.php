...
## Fork test
## Automate - Player takes position 9 
## in TicTacToe.php - hardcoded AI takes 1
## Player Takes position #6
## AI Blocks position 3
## PLayer blocks position 2 this should setup AI to take position 7 
